...
namespace mmoa.Api
{
    public static class Setup
    {
        ...
        {
            services.AddScoped<MmoaContext, MmoaContext>();

            services.AddTransient<IUnitOfWork, UnitOfWork>();

            services.AddTransient<IRepositoryUser, RespositoryUser>();
        }
